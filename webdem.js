...
function loadSpreaderCAD() {
  ...
  loader.load(
    ...
    (gltf) => {
      ...
      console.log("spreader.glb loaded");
    },
    undefined,
    (err) => {
      console.warn("Could not load spreader.glb:", err);
    }
  );
}
...
function init() {
  ...
  hopperBlock.position.set(0, 2.35, 0);
  scene.add(hopperBlock);
